...
const CourseCard = ({ course, onDelete }) => {
  ...
  return (
      <div className={`w-[237px] h-[229px] rounded-[6px] ${bgColor} relative cursor-pointer`}>
        ...
        {showActions && (
            ...
            >
              <Link to={`/CourseEdit/${course.id}`}>
                <div className="flex items-center px-4 py-2 text-yellow-600 hover:bg-yellow-100 cursor-pointer">
                  <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
