        ...
        <div className="bg-white p-4 rounded shadow">
            <div className="mb-4">
                <button
                    ...
                    className={`mr-4 ${activeTab === "All clients" ? "font-bold" : ""}`}
                >
                    All clients
                </button>
                <button
                    onClick={() => setActiveTab("Active")}
                    className={`mr-4 ${activeTab === "Active" ? "font-bold" : ""}`}
                >
                    Active
                </button>
                <button
                    onClick={() => setActiveTab("Inactive")}
                    className={`${activeTab === "Inactive" ? "font-bold" : ""}`}
                >
                    Inactive
                </button>
            </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    {displayedStudents.map((student) => (
                        <tr key={student?.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">{student?.phone == null ? "099999121" : student?.phone}  </td>
                            <td className="px-6 py-4 whitespace-nowrap">{student?.email}</td>
                            <td className="px-6 py-4 whitespace-nowrap">
                                {student?.location == null ? "Nigeria" : student?.location}
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                  <span
